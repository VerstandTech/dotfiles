...
*Canonical location: `agents-shared/.agents/adapters/pi/personal/docs/high-assurance-playbook.md` in [VerstandTech/dotfiles](https://github.com/VerstandTech/dotfiles).*
